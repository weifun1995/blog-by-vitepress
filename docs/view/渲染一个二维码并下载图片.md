---
name: jr-qrcode
description: 常用的QRcode依赖需要先定义一个dom*节点进行进行渲染，对于一些需要生成多个或者下载图片的需求显得有点苍白无力，最后发现jr-qrcode可以实现直接把生成的二维码转成Base64 URL形式输出。
tag: 插件
---

# jr-qrcode
:::tip
[详情](https://github.com/diamont1001/jrQrcode)
:::
